...
//告警类型所对应的供选择项
const emergency_type = [{ "label": '手动选择阈值', "key": "value" }, { "label": '自动基线', "key": "line" }, { "label": '系统健康', "key": "helath" }];//为方便区分,用"value"代表'手动选择阈值',"line"代表 '自动基线',"helath"代表 '系统健康'
//告警对象第一个选择框可供选择的选择项
const emergency_obj = {
                        ...
                        <Form.Item
                            ...
                            >
                                {getFieldDecorator('description', {
                                    ...
                                    <Input.TextArea rows={8} placeholder="The dns description"   style={{ "width": '67.5%',"height":"80px" }}/>
                                )}
                            </Form.Item>
